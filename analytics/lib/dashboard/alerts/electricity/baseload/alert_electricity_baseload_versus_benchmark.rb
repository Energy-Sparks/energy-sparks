...
class AlertElectricityBaseloadVersusBenchmark < AlertBaseloadBase
  ...
  private def calculate(asof_date)
    ...
    @benchmark_per_pupil_kw = BenchmarkMetrics.recommended_baseload_for_pupils(pupils:,
    ...
    @exemplar_per_pupil_kw = BenchmarkMetrics.exemplar_baseload_for_pupils(pupils:,
                                                                           school_type: school_type,
                                                                           heat_pump: @school.heat_pump?)

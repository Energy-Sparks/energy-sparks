...
# Dashboard analytics
# gem 'energy-sparks_analytics', github: 'Energy-Sparks/energy-sparks_analytics', tag: '5.1.6'
gem 'energy-sparks_analytics', github: 'Energy-Sparks/energy-sparks_analytics', branch: 'gas-target-estimation-changes'

...
# Dashboard analytics
gem 'energy-sparks_analytics', github: 'Energy-Sparks/energy-sparks_analytics', branch: '4492-dont-run-insulate-hot-water-pipes-alert-for-schools-with-swimming-pools'

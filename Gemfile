...
gem 'after_party', require: false # load data after deploy

# Dashboard analytics
gem 'energy-sparks_analytics', '~> 0.11.0', git: 'https://github.com/PhilipTB/energy-sparks_analytics.git', branch: 'integration'

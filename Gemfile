...
# Dashboard analytics
gem 'energy-sparks_analytics', git: 'https://github.com/Energy-Sparks/energy-sparks_analytics.git', tag: '1.21.0'
# gem 'energy-sparks_analytics', git: 'https://github.com/Energy-Sparks/energy-sparks_analytics.git', branch: '1587-create-interface-for-app-to-request-current-progress-against-targets-from-analytics'

...
ActiveRecord::Schema.define(version: 2024_05_20_173339) do
  ...
  create_table "alert_errors", force: :cascade do |t|
    ...
    t.index ["report_id"], name: "index_alert_errors_on_report_id"
  end
  ...
  add_foreign_key "alert_errors", "comparison_reports", column: "report_id"
  ...
  add_foreign_key "alerts", "comparison_reports", column: "report_id"

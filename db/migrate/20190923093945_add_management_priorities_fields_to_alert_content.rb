class AddManagementPrioritiesFieldsToAlertContent < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :alert_type_rating_content_versions, :management_priorities_start_date, :string
    add_column :alert_type_rating_content_versions, :management_priorities_end_date, :string
  end
end

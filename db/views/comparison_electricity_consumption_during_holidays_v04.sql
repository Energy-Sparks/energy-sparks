...
WHERE (alert_types.class_name = 'Alerts::Electricity::UsageDuringCurrentHolidayWithCommunityUse'
       AND alerts.enough_data = 1)
  OR alert_types.class_name = 'AlertElectricityUsageDuringCurrentHoliday'

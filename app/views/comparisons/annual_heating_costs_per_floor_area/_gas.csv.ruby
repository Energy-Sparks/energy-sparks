CSV.generate do |csv|
  ...
  @results.each do |result|
    csv << [
      ...
      format_unit(result.one_year_gas_per_floor_area_gbp, Float),
      format_unit(result.one_year_gas_per_floor_area_co2, Float),
      format_unit(result.saving_or_nil(:one_year_gas_saving_versus_exemplar_gbpcurrent), Float),
    ]
  end
end.html_safe

CSV.generate do |csv|
  ...
  @results.each do |result|
    csv << [
      result.school.name,
      format_unit(result.schoolday_open_percent, Float, true, :benchmark),
      format_unit(result.schoolday_closed_percent, Float, true, :benchmark),
      format_unit(result.holidays_percent, Float, true, :benchmark),
      format_unit(result.weekends_percent, Float, true, :benchmark),
      format_unit(result.community_percent, Float, true, :benchmark),

...
module Solar
  class SolarEdgeInstallationFactory
    def initialize(
      ...
      raise ArgumentError,
            'Amr Data Feed Config is not set for the Solar Edge API'
    end
    ...
    def perform
      installation = SolarEdgeInstallation.where(school_id: @school.id, mpan: @mpan, site_id: @site_id,
                                                 api_key: @api_key, amr_data_feed_config: @amr_data_feed_config).first_or_create!

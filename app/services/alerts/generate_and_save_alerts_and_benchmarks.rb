module Alerts
  class GenerateAndSaveAlertsAndBenchmarks
    ...
    def perform
      ...
      if alert_reports.any?
        alert_reports.each do |alert_report|
          process_alert_report(alert_report, alerts_to_save, alert_errors_to_save, benchmark_results_to_save)
        end
      end
    ...
    def process_alert_report(alert_report, alerts_to_save, alert_errors_to_save, benchmark_results_to_save)

  ...
  class DownloadsController < ApplicationController
    ...
    def index
      respond_to do |format|
        format.html
        format.csv { send_data readings_to_csv(AmrValidatedReading.download_query_for_school(@school), SCHOOL_CSV_HEADER), type: 'text/csv; charset=utf-8; header=present', filename: "school-amr-readings-#{@school.name.parameterize}.csv" }
      end
    end
  end
end

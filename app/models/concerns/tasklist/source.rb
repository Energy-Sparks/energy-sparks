module Tasklist
  module Source
    ...
    included do
      ...
      has_many :activity_type_tasks, -> { activity_types.positioned }, as: :tasklist_source, class_name: 'Tasklist::Task', inverse_of: :tasklist_source
      has_many :intervention_type_tasks, -> { intervention_types.positioned }, as: :tasklist_source, class_name: 'Tasklist::Task', inverse_of: :tasklist_source

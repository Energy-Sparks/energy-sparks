...
class EnergyTariff < ApplicationRecord
  ...
  def to_hash
    rates = rates_attrs
    {
      start_date: start_date ? start_date.to_fs(:es_compact) : Date.new(2000, 1, 1).to_fs(:es_compact),
      end_date: end_date ? end_date.to_fs(:es_compact) : Date.new(2050, 1, 1).to_fs(:es_compact),

...
class EquivalenceType < ApplicationRecord
  ...
  enum image_name: [:no_image, :petrol_car, :electric_car, :meal, :solar_panel, :books, :electric_shower, :house, :kettle, :phone, :pizza, :roast_meal, :television, :tree, :video_game, :offshore_wind_turbine, :onshore_wind_turbine, :solar_panel_bw, :electric_car_bw, :meal_bw]

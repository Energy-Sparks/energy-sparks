...
class EquivalenceType < ApplicationRecord
  ...
  enum image_name: { no_image: 0, petrol_car: 1, electric_car: 2, meal: 3, solar_panel: 4, books: 5, electric_shower: 6, house: 7, kettle: 8, phone: 9, pizza: 10, roast_meal: 11, television: 12, tree: 13, video_game: 14, offshore_wind_turbine: 15, onshore_wind_turbine: 16, gas_shower: 17, solar_panel_bw: 18, electric_car_bw: 19, meal_bw: 20 }

...
module Merit
  class BadgeRules
    ...
    def initialize
      ...
      grant_on 'schools#create', badge: 'registered', to: :itself
      ...
      grant_on ['schools#create', 'schools#update'], badge: 'eco-programme' do |school|
        school.eco_school_status.present? && !school.eco_school_status.zero?
      end
    end
  end
end

...
class Alert < ApplicationRecord
  ...
  scope :without_exceptions, -> { joins(:alert_type).joins('LEFT OUTER JOIN school_alert_type_exceptions ON school_alert_type_exceptions.school_id = alerts.school_id AND school_alert_type_exceptions.alert_type_id = alert_types.id').where(school_alert_type_exceptions: { school_id: nil }) }

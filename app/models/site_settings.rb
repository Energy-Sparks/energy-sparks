...
class SiteSettings < ApplicationRecord
  ...
  validates :electricity_price, :solar_export_price, :gas_price, :oil_price, numericality: { only_float: true, allow_blank: false } if EnergySparks::FeatureFlags.active?(:use_site_settings_current_prices)

  ...
  class SummaryTableData
    ...
    def summary_data_for(fuel_type, period)
      OpenStruct.new(
        ...
        usage_text: format_number(fetch(fuel_type, period, :kwh), :kwh, :text),
        co2: format_number(fetch(fuel_type, period, :co2), :kg),
        co2_text: format_number(fetch(fuel_type, period, :co2), :kg, :text),
        cost: format_number(fetch(fuel_type, period, :£), :£),
        cost_text: format_number(fetch(fuel_type, period, :£), :£, :text),
        savings: format_number(fetch(fuel_type, period, :savings_£), :£),
        savings_text: format_number(fetch(fuel_type, period, :savings_£), :£, :text),

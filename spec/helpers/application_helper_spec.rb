...
describe ApplicationHelper do
  ...
  describe 'nice_dates' do
    ...
    it 'outputs dates as strings in a nice way' do
      ...
      I18n.locale = 'cy'
      # Test for changes in abbreviated day output
      expect(helper.nice_dates(Date.strptime("01/01/2022", "%d/%m/%Y"))).to eq('Sad 1af Ion 2022')
      expect(helper.nice_dates(Date.strptime("02/01/2022", "%d/%m/%Y"))).to eq('Sul 2ail Ion 2022')
      expect(helper.nice_dates(Date.strptime("03/01/2022", "%d/%m/%Y"))).to eq('Llu 3ydd Ion 2022')
      expect(helper.nice_dates(Date.strptime("04/01/2022", "%d/%m/%Y"))).to eq('Maw 4ydd Ion 2022')
      expect(helper.nice_dates(Date.strptime("05/01/2022", "%d/%m/%Y"))).to eq('Mer 5ed Ion 2022')
      expect(helper.nice_dates(Date.strptime("06/01/2022", "%d/%m/%Y"))).to eq('Iau 6ed Ion 2022')
      expect(helper.nice_dates(Date.strptime("07/01/2022", "%d/%m/%Y"))).to eq('Gwe 7fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("08/01/2022", "%d/%m/%Y"))).to eq('Sad 8fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("09/01/2022", "%d/%m/%Y"))).to eq('Sul 9fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("10/01/2022", "%d/%m/%Y"))).to eq('Llu 10fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("11/01/2022", "%d/%m/%Y"))).to eq('Maw 11eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("12/01/2022", "%d/%m/%Y"))).to eq('Mer 12fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("13/01/2022", "%d/%m/%Y"))).to eq('Iau 13eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("14/01/2022", "%d/%m/%Y"))).to eq('Gwe 14eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("15/01/2022", "%d/%m/%Y"))).to eq('Sad 15fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("16/01/2022", "%d/%m/%Y"))).to eq('Sul 16eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("17/01/2022", "%d/%m/%Y"))).to eq('Llu 17eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("18/01/2022", "%d/%m/%Y"))).to eq('Maw 18fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("19/01/2022", "%d/%m/%Y"))).to eq('Mer 19eg Ion 2022')
      expect(helper.nice_dates(Date.strptime("20/01/2022", "%d/%m/%Y"))).to eq('Iau 20fed Ion 2022')
      expect(helper.nice_dates(Date.strptime("21/01/2022", "%d/%m/%Y"))).to eq('Gwe 21ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("22/01/2022", "%d/%m/%Y"))).to eq('Sad 22ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("23/01/2022", "%d/%m/%Y"))).to eq('Sul 23ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("24/01/2022", "%d/%m/%Y"))).to eq('Llu 24ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("25/01/2022", "%d/%m/%Y"))).to eq('Maw 25ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("26/01/2022", "%d/%m/%Y"))).to eq('Mer 26ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("27/01/2022", "%d/%m/%Y"))).to eq('Iau 27ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("28/01/2022", "%d/%m/%Y"))).to eq('Gwe 28ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("29/01/2022", "%d/%m/%Y"))).to eq('Sad 29ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("30/01/2022", "%d/%m/%Y"))).to eq('Sul 30ain Ion 2022')
      expect(helper.nice_dates(Date.strptime("31/01/2022", "%d/%m/%Y"))).to eq('Llu 31ain Ion 2022')
      # Test for changes in abbreviated month output
      expect(helper.nice_dates(Date.strptime("01/02/2022", "%d/%m/%Y"))).to eq('Maw 1af Chw 2022')
      expect(helper.nice_dates(Date.strptime("01/03/2022", "%d/%m/%Y"))).to eq('Maw 1af Maw 2022')
      expect(helper.nice_dates(Date.strptime("01/04/2022", "%d/%m/%Y"))).to eq('Gwe 1af Ebr 2022')
      expect(helper.nice_dates(Date.strptime("01/05/2022", "%d/%m/%Y"))).to eq('Sul 1af Mai 2022')
      expect(helper.nice_dates(Date.strptime("01/06/2022", "%d/%m/%Y"))).to eq('Mer 1af Meh 2022')
      expect(helper.nice_dates(Date.strptime("01/07/2022", "%d/%m/%Y"))).to eq('Gwe 1af Gor 2022')
      expect(helper.nice_dates(Date.strptime("01/08/2022", "%d/%m/%Y"))).to eq('Llu 1af Aws 2022')
      expect(helper.nice_dates(Date.strptime("01/09/2022", "%d/%m/%Y"))).to eq('Iau 1af Med 2022')
      expect(helper.nice_dates(Date.strptime("01/10/2022", "%d/%m/%Y"))).to eq('Sad 1af Hyd 2022')
      expect(helper.nice_dates(Date.strptime("01/11/2022", "%d/%m/%Y"))).to eq('Maw 1af Tac 2022')
      expect(helper.nice_dates(Date.strptime("01/12/2022", "%d/%m/%Y"))).to eq('Iau 1af Rha 2022')
    end
  end

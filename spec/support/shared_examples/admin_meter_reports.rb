...
RSpec.shared_examples 'an admin meter report' do |help: true|
  ...
  it 'has metadata' do
    expect(page).to have_text(frequency.to_s.humanize)
  end
...
RSpec.shared_examples 'an admin meter import report', :include_application_helper do |data: true|
  ...
  it 'allows csv download' do
    ...
    csv = [['School Group', 'Admin', 'School', 'Meter',

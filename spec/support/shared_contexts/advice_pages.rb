...
RSpec.shared_context 'electricity advice page' do
  ...
  include_context 'advice page base'
  let!(:advice_page) do
    create(:advice_page, key: key, restricted: false, fuel_type: fuel_type, learn_more: learn_more_content)
  end
  ...
  let(:meter_collection) do
    double('meter-collection', electricity_meters: [build(:meter, type: :electricity)], solar_pv_panels?: true)
  end
  ...
  before do
    ...
    allow(aggregate_meter).to receive(:mpan_mprn).and_return(912_345)

  ...
  let(:expected_results) do
    { :electricity =>
     ...
     :other =>
      { :total_energy_use =>
        { :other_school =>
          [{ 'advice_page_key' => 'total_energy_use', 'cluster_name' => 'A Cluster', 'fuel_type' => nil, 'school_id' => 1, 'school_slug' => 'school-1', 'school_name' => 'School 1', 'benchmarked_as' => 0 },
         ...
         :exemplar_school =>
          [{ 'advice_page_key' => 'total_energy_use', 'cluster_name' => nil, 'fuel_type' => nil, 'school_id' => 10, 'school_slug' => 'school-10', 'school_name' => 'School 10', 'benchmarked_as' => 2 },
         ...
         :benchmark_school =>
          [{ 'advice_page_key' => 'total_energy_use', 'cluster_name' => nil, 'fuel_type' => nil, 'school_id' => 17, 'school_slug' => 'school-17', 'school_name' => 'School 17', 'benchmarked_as' => 1 },

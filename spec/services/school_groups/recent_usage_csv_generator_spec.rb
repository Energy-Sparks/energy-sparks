...
RSpec.describe SchoolGroups::RecentUsageCsvGenerator do
  ...
  let!(:school_1) do
    create(:school, school_group: school_group, number_of_pupils: 10, floor_area: nil, name: 'A school')
  end
  let!(:school_2) do
    create(:school, school_group: school_group, number_of_pupils: 20, floor_area: 300.0, name: 'B school')
  end
  let!(:cluster) do
    create(:school_group_cluster, name: 'A Cluster', school_group: school_group, schools: [school_1])
  end

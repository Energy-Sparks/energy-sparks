...
RSpec.describe Schools::AdvicePageBenchmarks::SchoolBenchmarkGenerator, type: :service do
  ...
  describe '.can_benchmark?' do
    ...
    context 'for existing benchmarks' do
      %i[baseload electricity_long_term gas_long_term electricity_out_of_hours gas_out_of_hours electricity_intraday thermostatic_control heating_control].each do |key|

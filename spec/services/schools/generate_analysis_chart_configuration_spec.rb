...
module Schools
  describe GenerateAnalysisChartConfiguration do
    ...
    let(:fuel_configuration) do
      FuelConfiguration.new(fuel_types_for_analysis: :electric_and_gas, has_electricity: true, has_gas: true)
    end
    ...
    describe '#generate' do
      it 'generates pupil charts' do
        ...
        chart_config = GenerateAnalysisChartConfiguration.new(school, nil, fuel_configuration,
                                                              page_config).generate([:pupil_analysis_page])

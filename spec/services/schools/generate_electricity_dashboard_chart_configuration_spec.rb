...
module Schools
  describe 'GenerateElectricityDashboardChartConfiguration' do
    ...
    context 'electricity dashboard chart configuration' do
      ...
      it 'returns the teachers chart if possible' do
    ...
    context 'no electricity dashboard chart configuration' do
      let(:fuel_configuration) { FuelConfiguration.new(fuel_types_for_analysis: :electric_only, has_electricity: false, has_gas: true) }

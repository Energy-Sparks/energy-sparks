...
describe ActivityTypeSearchService do
  ...
  context 'search by query term' do
    ...
    it 'must match all words' do
      ...
      expect(ActivityTypeSearchService.search('baz')).to contain_exactly(activity_type_1, activity_type_2)
    end
    ...
    it 'matches plurals' do
      ...
      expect(ActivityTypeSearchService.search('thing')).to contain_exactly(activity_type_1, activity_type_2)
      expect(ActivityTypeSearchService.search('things')).to contain_exactly(activity_type_1, activity_type_2)
    end
  ...
  context 'search by query term and key stages' do
    it 'filters by key stage' do
      ...
      expect(ActivityTypeSearchService.search('foo')).to contain_exactly(activity_type_1, activity_type_2)

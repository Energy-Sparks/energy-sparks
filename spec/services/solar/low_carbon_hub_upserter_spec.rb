...
module Solar
  describe LowCarbonHubUpserter do
    ...
    let(:low_carbon_hub_installation) do
      create(:low_carbon_hub_installation, rbee_meter_id: rbee_meter_id, school: school)
    end
    ...
    let(:readings) do
      {
        solar_pv: {
          ...
          readings: {
            start_date => OneDayAMRReading.new(70_000_000_123_085, start_date, 'ORIG', nil, start_date,
                                               Array.new(48, 0.25)),
        ...
        electricity: {
          ...
          readings: {
            start_date => OneDayAMRReading.new(90_000_000_123_085, start_date, 'ORIG', nil, start_date,
                                               Array.new(48, 0.25)),
        ...
        exported_solar_pv: {
          ...
          readings: {
            start_date => OneDayAMRReading.new(60_000_000_123_085, start_date, 'ORIG', nil, start_date,
                                               Array.new(48, 0.25)),
    ...
    context 'with no existing meters' do
      it 'creates new inactive pseudo meters' do
        expect do
          LowCarbonHubUpserter.new(installation: low_carbon_hub_installation, readings: readings,
    ...
    context 'when pseudo meter exists' do
      let!(:existing_pseudo_meter) do
        create(:electricity_meter, low_carbon_hub_installation: low_carbon_hub_installation, name: 'Existing meter',
                                   mpan_mprn: expected_electricity_mpan, school: low_carbon_hub_installation.school, pseudo: true)
      end
      ...
      context 'with no installation or pseudo flag' do
        let!(:existing_pseudo_meter) do
          create(:electricity_meter, low_carbon_hub_installation: nil, name: 'Existing meter',
                                     mpan_mprn: expected_electricity_mpan, school: low_carbon_hub_installation.school, pseudo: false)
        end

...
describe Solar::MeterZDownloadAndUpsert do
  ...
  let!(:meter) { create(:solar_pv_meter, meter_z_installation: installation, meter_serial_number: 'meter_id') }
  ...
  describe '#perform' do
    before do
      ...
      stub_request(:get, 'https://api.meterz.co.uk/v1/organisations/organisation_id/sites/site_id/meters/meter_id' \

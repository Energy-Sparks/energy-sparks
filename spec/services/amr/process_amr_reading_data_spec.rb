...
module Amr
  describe ProcessAmrReadingData do
    ...
    let(:reading_data_warning)      { { :mpan_mprn => nil, :reading_date => Date.parse('2019-01-03'), readings: Array.new(48, '0.0'), amr_data_feed_config_id: amr_data_feed_import_log.amr_data_feed_config_id, warnings: [:missing_mpan_mprn]} }

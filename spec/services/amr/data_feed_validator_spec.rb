...
describe Amr::DataFeedValidator do
  context 'for a typical config' do
  ...
  context 'for a row per reading data file that splits the date and time into two columns' do
    let(:header)       { 'Read date,Time,Site Name,Actual (KWH)' }

    let(:header_row)   { header.split(",") }

    let(:corona_config) do
      build(:amr_data_feed_config,
        description: 'Corona Portal',
        identifier: 'corona-portal',
    ...
    before do
      @readings = [
        header_row,
        ["01/06/2023", "00:00", "1234567890", "0.123"],
        ["01/06/2023", "00:30", "1234567890", "0.123"],
        ["01/06/2023", "01:00", "1234567890", "0.123"],
        ["01/06/2023", "01:30", "1234567890", "0.123"],
        ["01/06/2023", "02:00", "1234567890", "0.123"],
        ["01/06/2023", "02:30", "1234567890", "0.123"],
        ["01/06/2023", "03:00", "1234567890", "0.123"],
        ["01/06/2023", "03:30", "1234567890", "0.123"],
        ["01/06/2023", "04:00", "1234567890", "0.123"],
        ["01/06/2023", "04:30", "1234567890", "0.123"],
        ["01/06/2023", "05:00", "1234567890", "0.123"],
        ["01/06/2023", "05:30", "1234567890", "0.123"],
        ["01/06/2023", "06:00", "1234567890", "0.123"],
        ["01/06/2023", "06:30", "1234567890", "0.123"],
        ["01/06/2023", "07:00", "1234567890", "0.123"],
        ["01/06/2023", "07:30", "1234567890", "0.123"],
        ["01/06/2023", "08:00", "1234567890", "0.123"],
        ["01/06/2023", "08:30", "1234567890", "0.123"],
        ["01/06/2023", "09:00", "1234567890", "0.123"],
        ["01/06/2023", "09:30", "1234567890", "0.123"],
        ["01/06/2023", "10:00", "1234567890", "0.123"],
        ["01/06/2023", "10:30", "1234567890", "0.123"],
        ["01/06/2023", "11:00", "1234567890", "0.123"],
        ["01/06/2023", "11:30", "1234567890", "0.123"],
        ["01/06/2023", "12:00", "1234567890", "0.123"],
        ["01/06/2023", "12:30", "1234567890", "0.123"],
        ["01/06/2023", "13:00", "1234567890", "0.123"],
        ["01/06/2023", "13:30", "1234567890", "0.123"],
        ["01/06/2023", "14:00", "1234567890", "0.123"],
        ["01/06/2023", "14:30", "1234567890", "0.123"],
        ["01/06/2023", "15:00", "1234567890", "0.123"],
        ["01/06/2023", "15:30", "1234567890", "0.123"],
        ["01/06/2023", "16:00", "1234567890", "0.123"],
        ["01/06/2023", "16:30", "1234567890", "0.123"],
        ["01/06/2023", "17:00", "1234567890", "0.123"],
        ["01/06/2023", "17:30", "1234567890", "0.123"],
        ["01/06/2023", "18:00", "1234567890", "0.123"],
        ["01/06/2023", "18:30", "1234567890", "0.123"],
        ["01/06/2023", "19:00", "1234567890", "0.123"],
        ["01/06/2023", "19:30", "1234567890", "0.123"],
        ["01/06/2023", "20:00", "1234567890", "0.123"],
        ["01/06/2023", "20:30", "1234567890", "0.123"],
        ["01/06/2023", "21:00", "1234567890", "0.123"],
        ["01/06/2023", "21:30", "1234567890", "0.123"],
        ["01/06/2023", "22:00", "1234567890", "0.123"],
        ["01/06/2023", "22:30", "1234567890", "0.123"],
        ["01/06/2023", "23:00", "1234567890", "0.123"],
        ["01/06/2023", "23:30", "1234567890", "0.123"]
      ]
    end

    it '' do
      results = Amr::DataFeedValidator.new(corona_config, @readings).perform
      expect(results.size).to eq(48)
      expect(results.first).to eq(@readings.second)
      expect(results.last).to eq(@readings.last)
    end
  end
end

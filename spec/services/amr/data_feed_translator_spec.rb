...
describe Amr::DataFeedTranslator do
  ...
  it 'errors if an mpan mprn is invalid' do
    readings = [
    ...
    expect { Amr::DataFeedTranslator.new(sheffield_config, readings).perform }.to raise_error(Amr::DataFeedException, "Invalid mpan_mprn '+2333300681718'")
  end

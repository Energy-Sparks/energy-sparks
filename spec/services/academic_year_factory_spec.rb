...
describe AcademicYearFactory, :academic_years, type: :service do
  ...
  it 'validates input' do
    expect { AcademicYearFactory.new(calendar).create(start_year: 2018, end_year: 2012) }.to raise_error(ArgumentError)
  end

  it 'allows setting of start and end month' do
    AcademicYearFactory.new(calendar, start_date: '01-08', end_date: '31-07').create(start_year: 2012, end_year: 2012)

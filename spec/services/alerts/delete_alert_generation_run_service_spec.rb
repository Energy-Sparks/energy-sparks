  ...
  describe '#delete' do
    ...
    context 'when there are older runs to delete' do
      it 'deletes only the older runs' do
        school.alert_generation_runs.create!(created_at: Time.zone.now)
        school.alert_generation_runs.create!(created_at: 13.days.ago)
        school.alert_generation_runs.create!(created_at: 1.month.ago)
        school.alert_generation_runs.create!(created_at: 3.months.ago)
      ...
      it 'deletes all of the dependent objects' do
        ...
        create(:alert, school: school, alert_type: gas_fuel_alert_type, created_at: date_time,
                       alert_generation_run: alert_generation_run)
        create(:alert, school: school, alert_type: electricity_fuel_alert_type, created_at: date_time,
                       alert_generation_run: alert_generation_run)
        create(:alert_error, alert_type: gas_fuel_alert_type, created_at: date_time,
                             alert_generation_run: alert_generation_run)
        create(:alert_error, alert_type: electricity_fuel_alert_type, created_at: date_time,
                             alert_generation_run: alert_generation_run)

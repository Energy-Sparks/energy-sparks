...
describe Ability do
  ...
  shared_examples 'adult contributions are visible and pupil content is protected' do
    context 'with activities' do
      ...
      it {
        expect(subject).not_to be_able_to(:view_contributed_content,
                                          create(:activity_without_creator, :with_contributors,
                                                 updated_by: create(:pupil)))
      }
    end
    ...
    context 'with interventions' do
      ...
      it {
        expect(subject).to be_able_to(:view_contributed_content,
                                      create(:observation, :intervention, :with_contributors))
      }
  ...
  shared_examples 'pupil contributions for school are accessible' do
    context 'with activities' do
      it {
        expect(subject).to be_able_to(:view_contributed_content,
                                      create(:activity_without_creator, :with_contributors, school: user.school,
                                                                                            updated_by: create(:pupil)))
      }
    end
    ...
    context 'with interventions' do
      it {
        expect(subject).to be_able_to(:view_contributed_content,
                                      create(:observation, :intervention, :with_contributors, school: user.school,
                                                                                              updated_by: create(:pupil)))
      }
    end
  end
  ...
  describe 'abilities' do
    ...
    context 'with a guest user' do
      ...
      context 'with schools' do
        ...
        context 'when data sharing is within_group' do
          ...
          %i[show show_pupils_dash show_management_dash read_restricted_advice read_restricted_analysis
             download_school_data].each do |permission|
        ...
        it_behaves_like 'they can manage correct types of tariffs', school_tariffs: false, group_tariffs: false,
                                                                    site_tariffs: false do
    ...
    context 'when user is an admin' do
        ...
        %i[show show_pupils_dash show_management_dash read_restricted_analysis].freeze.each do |permission|
          [true, false].freeze.each do |visibility|
            School.data_sharings.each_key do |data_sharing|
              it {
                expect(subject).to be_able_to(permission,
                                              create(:school, visible: visibility, data_sharing: data_sharing))
              }
            end
          end
        end
      ...
      it_behaves_like 'they can manage correct types of tariffs', school_tariffs: true, group_tariffs: true,
                                                                  site_tariffs: true do
        let(:school) { create(:school, :with_school_group) }
      end
    end
      ...
      shared_examples 'a user with common group permissions' do
        ...
        context 'with contributed content' do
          ...
          context 'with activities' do
            it {
              expect(subject).to be_able_to(:view_contributed_content,
                                            create(:activity_without_creator, :with_contributors, school: create(:school, school_group:),
                                                                                                  updated_by: create(:pupil)))
            }
          end
          ...
          context 'with interventions' do
            it {
              expect(subject).to be_able_to(:view_contributed_content,
                                            create(:observation, :intervention, :with_contributors, school: create(:school, school_group:),
                                                                                                    updated_by: create(:pupil)))
            }
          end
        end
        ...
        context 'when completing onboarding' do
          context 'with an onboarding that has not started' do
            ...
            context 'when it is not their group' do
              it {
                expect(subject).not_to be_able_to(:manage,
                                                  create(:school_onboarding, school_group: create(:school_group)))
              }
            end
          end
          ...
          context 'with an onboarding that has started' do
            ...
            context 'with a school in another group' do
              ...
              let(:school_onboarding) do
                create(:school_onboarding, school_group: other_group,
                                           school: create(:school, school_group: other_group))
              end

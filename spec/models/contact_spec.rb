...
describe Contact do
  ...
  describe 'email validation' do
    ...
    it 'checks for unique email address within the school' do
      expect(build(:contact, school: school, name: 'test', email_address: 'test@example.com')).not_to be_valid
  ...
  describe 'phone validation' do
    ...
    it 'checks for unique phone number within the school' do
      expect(build(:contact, school: school, name: 'test', mobile_phone_number: '01122333444')).not_to be_valid

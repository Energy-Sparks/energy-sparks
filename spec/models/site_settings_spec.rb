...
describe SiteSettings do
  describe '#current' do
    it 'returns the newest site setting record' do
      3.times { SiteSettings.create!(electricity_price: 1, solar_export_price: 1, gas_price: 1, oil_price: 1) }
  ...
  describe '#temperature_recording_month_numbers' do
    it 'returns temperature recording months as a compacted array of integers' do
      SiteSettings.create!(electricity_price: 1, solar_export_price: 1, gas_price: 1, oil_price: 1, temperature_recording_months: ['10', nil, '12', '1', '2', nil, '4'])
  ...
  describe 'prices' do
    it 'validates values for all price fields are floats' do
      site_setting = SiteSettings.new(electricity_price: 1, solar_export_price: 1, gas_price: 1, oil_price: 1)

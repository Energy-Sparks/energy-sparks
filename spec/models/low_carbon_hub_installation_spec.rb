    ...
    context 'when there is an electricity meter' do
      context 'with no readings' do
        let!(:electricity_meter) do
          create(:electricity_meter, mpan_mprn: 60_000_000_000_000 + low_carbon_hub_installation.rbee_meter_id.to_i,
                                     pseudo: true, low_carbon_hub_installation: low_carbon_hub_installation)
        end

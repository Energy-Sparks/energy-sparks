FactoryBot.define do
  factory :solar_edge_installation do
    ...
    factory :solar_edge_installation_with_meters_and_validated_readings do
      ...
      after(:create) do |solar_edge_installation, evaluator|
        electricity_meter = create(:electricity_meter_with_validated_reading, mpan_mprn: 60000000000000 + solar_edge_installation.mpan.to_i, pseudo: true, solar_edge_installation: solar_edge_installation)

FactoryBot.define do
  factory :calendar_event do
    ...
    factory :bank_holiday do
      ...
      association :calendar_event_type, term_time: false, holiday: false, bank_holiday: true,
                                        analytics_event_type: :bank_holiday, title: 'Bank Holiday'
    end
    factory :inset_day do
      description { 'this is a new inset day event' }
      association :calendar
      association :calendar_event_type, term_time: false, holiday: false, bank_holiday: false, inset_day: true,
                                        analytics_event_type: :inset_day_in_school, title: 'In school Inset Day'
    end
  end
end

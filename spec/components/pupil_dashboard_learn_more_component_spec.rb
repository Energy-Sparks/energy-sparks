...
RSpec.describe PupilDashboardLearnMoreComponent, :include_url_helpers, type: :component do
  ...
  shared_examples 'a data enabled panel' do
    ...
    it { expect(html).to have_text(I18n.t('components.dashboard_learn_more.pupil.title')) }
    ...
    context 'with all fuel types' do
      ...
      it { expect(html).to have_text(I18n.t('pupils.analysis.without_storage_heaters')) }
    end
    ...
    context 'with only electricity' do
      ...
      it { expect(html).to have_no_text(I18n.t('pupils.analysis.without_storage_heaters')) }
    end
  ...
  context 'when school is not data enabled' do
    ...
    it { expect(html).to have_text(I18n.t('pupils.schools.show.setting_up')) }

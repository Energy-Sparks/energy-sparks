...
RSpec.describe HolidayUsageTableComponent, type: :component do
  ...
  let(:holiday_1) do
    build(:school_date_period, type: :spring_half_term, start_date: Date.new(2023, 2, 18),
                               end_date: Date.new(2023, 2, 21))
  end
  let(:holiday_2) do
    build(:school_date_period, type: :easter, start_date: Date.new(2023, 4, 29), end_date: Date.new(2023, 5, 1))
  end
  let(:holiday_3) do
    build(:school_date_period, type: :summer, start_date: Date.new(2023, 6, 30), end_date: Date.new(2023, 8, 13))
  end
  let(:holiday_4) do
    build(:school_date_period, type: :autumn_half_term, start_date: Date.new(2023, 10, 7), end_date: final_holiday_end)
  end

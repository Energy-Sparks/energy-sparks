    ...
    expect(
      ...
      <<~HTML.chomp
        <div class="input-group date" id="datetimepickerform_start_date" data-target-input="nearest">
          <input class="form-control datetimepicker-input" data-target="#datetimepickerform_start_date" type="text" name="job[start_date]" id="job_start_date" value="01/12/2022" />

class TimelineComponentPreview < ViewComponent::Preview
  def with_observations
    ...
    observations = [
      ...
      Observation.new(school: audit.school, observable: audit, variation: 'ActivitiesCompleted', at: Time.zone.yesterday, points: SiteSettings.current.audit_activities_bonus_points),

...
RSpec.describe 'Managing a school group', :include_application_helper, :school_groups do
  ...
  describe 'Header' do
    ...
    context "when clicking on 'All school groups'" do
      ...
      it { expect(page).to have_current_path(admin_school_groups_path(project_group: false)) }
    end
  ...
  describe 'Button panel' do
    ...
    context "when clicking 'Meter report'" do

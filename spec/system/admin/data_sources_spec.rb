      ...
      context 'when there is a data source' do
        ...
        describe 'Managing a data source' do
          ...
          context 'Summary panel' do
            ...
            let(:active_meters) { create_list(:gas_meter, 3, active: true, data_source: existing_data_source, school: school) }
            let(:inactive_meters) { create_list(:gas_meter, 2, active: false, data_source: existing_data_source) }

...
describe 'TariffsReport', :include_application_helper, type: :system do
  ...
  let!(:meter)                  { create(:electricity_meter, dcc_meter: :smets2, consent_granted: true, school: school) }

  let!(:meter_without_group)    { create(:electricity_meter, dcc_meter: :smets2, consent_granted: true, school: school_without_group) }

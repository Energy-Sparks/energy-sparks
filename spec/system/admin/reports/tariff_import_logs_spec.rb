...
describe TariffImportLog, :include_application_helper, type: :system do
  ...
  it 'shows import logs' do
    ...
    log_1 = create(:tariff_import_log, description: 'import one', error_messages: error_messages,
                                       import_time: 2.days.ago)
    log_2 = create(:tariff_import_log, description: 'import two', standing_charges_imported: 111,
                                       standing_charges_updated: 222, prices_imported: 333, prices_updated: 444, import_time: 1.day.ago)

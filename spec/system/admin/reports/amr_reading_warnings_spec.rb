...
describe AmrReadingWarning, type: :system, include_application_helper: true do
  ...
  let!(:warning)  { AmrReadingWarning.create(amr_data_feed_import_log: log, mpan_mprn: mpan, warning: :missing_readings, warning_message: AmrReadingData::WARNINGS[:missing_readings]) }

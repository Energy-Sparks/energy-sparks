...
describe 'Gas anomaly report' do
  ...
  it 'displays the table' do
    ...
    today_temp = FormatUnit.format(:temperature, anomaly.today_temperature.to_f, :html, false, true)
    prev_temp = FormatUnit.format(:temperature, anomaly.previous_temperature.to_f, :html, false, true)

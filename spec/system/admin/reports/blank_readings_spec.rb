...
describe 'Blank Readings Report', :include_application_helper do
  ...
  before do
    ...
    click_on 'Blank readings'
  end

  it_behaves_like 'an admin meter report', help: false do
    let(:title) { 'Meters with recent blank readings' }
    let(:description) { 'Meters where we have received one or more days of entirely blank data in the last 24 hours' }
  end

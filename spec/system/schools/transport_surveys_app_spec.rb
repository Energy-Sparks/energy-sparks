              ...
              context 'when selecting a time' do
                ...
                context 'when selecting a transport type where carbon cannot be shared' do
                  ...
                  context 'when clicking back button' do
                    ...
                    it {
                      expect(page).to have_text('Transport: What mode of transport did you use to get to school?')
                    }
                  end
                  ...
                  context 'when confirming selection' do
                    ...
                    let(:carbon) do
                      (((transport_type.speed_km_per_hour * time) / 60) * transport_type.kg_co2e_per_km).round(3)
                    end
                ...
                context 'when selecting a transport type where carbon can be shared' do
                  ...
                  it {
                    expect(page).to have_text("Sharing: How many pupils at this school shared your #{transport_type.image} #{transport_type.name} journey?")
                  }
                  ...
                  context 'when selecting passengers' do
                    ...
                    context 'when confirming selection' do
                      ...
                      let(:carbon) do
                        ((((transport_type.speed_km_per_hour * time) / 60) * transport_type.kg_co2e_per_km) / passengers).round(3)
                      end

...
describe 'consent documents', type: :system do
  ...
  context 'as a school admin' do
        ...
        context 'when consent is up to date' do
          ...
          context 'when bill uploaded' do
            ...
            context 'when there is a default admin for the school group' do
              let(:admin_owned_school)             do
                create(:school, name: 'Admin School', school_group:, bill_requested: true)
              end
          ...
          context 'when bill edited' do
            ...
            context 'when there is a default admin for the school group' do
              ...
              before do
                sign_in(admin_owned_school_admin)
                bill = create(:consent_document, school: admin_owned_school, description: 'Proof!',
                                                 title: 'Our Energy Bill')
    ...
    context 'when viewing consent documents' do
      let!(:consent_document) do
        create(:consent_document, school: school, description: 'Proof!', title: 'Our Energy Bill')
      end

...
RSpec.shared_examples 'dashboard chart display' do
  ...
  context 'and all charts can be shown' do
    ...
    let(:dashboard_charts) { %i[management_dashboard_group_by_week_electricity management_dashboard_group_by_week_gas management_dashboard_group_by_week_storage_heater management_dashboard_group_by_month_solar_pv] }
  ...
  context 'and there are limited charts' do
    ...
    let(:dashboard_charts) { %i[management_dashboard_group_by_week_electricity management_dashboard_group_by_week_gas] }

...
RSpec.shared_examples 'target prompts' do
  context 'when no target is set' do
    ...
    it 'displays prompt' do
      expect(page).to have_text("Set targets to reduce your school's energy consumption")
    ...
    context 'and not enough data' do
      ...
      it 'doesnt display prompt' do
        expect(page).to have_no_text("Set targets to reduce your school's energy consumption")
      end
    end
  ...
  context 'when target is expired' do
    ...
    it 'prompts to set a new target' do
      ...
      expect(page).to have_text("It's time to review your progress and set a new target for the year ahead")
    end
  end
end
    ...
    context "as #{role}" do
      ...
      context 'when no target is set' do
        ...
        it 'does not display target prompt' do
          expect(page).to have_no_text("Set targets to reduce your school's energy consumption")
          expect(page).to have_no_link('Set energy saving target')
        end
      end
    end
  end

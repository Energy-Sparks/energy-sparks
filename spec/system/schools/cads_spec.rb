...
describe 'CADs', type: :system do
  ...
  context 'as an admin', with_feature: :new_manage_school_pages do
    ...
    it 'allows CAD to be created, edited, deleted' do
      ...
      expect(page).to have_text('Manage CADs')
      click_link 'Add CAD'
      fill_in 'Name', with: 'My First CAD'
      fill_in 'Device identifier', with: '1234-5678'
      click_button 'Save'
      expect(page).to have_text('CAD was successfully created')
      expect(page).to have_text('My First CAD')
      click_link 'Edit'
      fill_in 'Maximum power (kW)', with: '5.5'
      fill_in 'Refresh interval (seconds)', with: '10'
      check 'Test mode'
      click_button 'Save'
      expect(page).to have_text('CAD was successfully updated')
      ...
      click_link 'Delete'
      expect(page).to have_text('CAD was successfully deleted')

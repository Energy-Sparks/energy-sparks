...
describe 'downloads', type: :system do
  ...
  let!(:meter)                    do
    create(:electricity_meter_with_validated_reading, name: 'Electricity meter', school: school, mpan_mprn: mpan)
  end
  ...
  context 'as admin' do
    ...
    it 'allows a download of all filtered by school' do
      filtered_meter_with_raw_data = create(:electricity_meter_with_reading, name: 'Electricity meter Filter',
                                                                             school: filtered_school)

...
RSpec.describe "gas long term advice page", type: :system do
  ...
  context 'as school admin' do
    ...
    context "clicking the 'Analysis' tab" do
      ...
      it 'includes expected sections' do
        ...
        expect(page).not_to have_content(I18n.t('advice_pages.gas_long_term.analysis.meter_breakdown.title'))
      end
      ...
      it 'includes expected charts' do
        ...
        expect(page).not_to have_css('#chart_wrapper_gas_longterm_trend')
      end
    end

  ...
  context 'when a school admin' do
    ...
    context "when on the 'Analysis' tab" do
      ...
      context 'with more than two years of meter data' do
        ...
        it_behaves_like 'it contains the monthly consumption table' do
          let(:expected_consumption_rows) do
            rows = [['January', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['February', '13,000', '14,000', '+3.6%', '£1,300', '£1,400', '+3.6%', '2,200', '2,300', '+2.9%'],
                    ['March', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['April', '14,000', '14,000', '0%', '£1,400', '£1,400', '0%', '2,400', '2,300', '-0.67%'],
                    ['May', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['June', '14,000', '14,000', '0%', '£1,400', '£1,400', '0%', '2,400', '2,300', '-0.67%'],
                    ['July', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['August', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['September', '14,000', '14,000', '0%', '£1,400', '£1,400', '0%', '2,400', '2,300', '-0.67%'],
                    ['October', '15,000', '15,000', '0%', '£1,500', '£1,500', '0%', '2,400', '2,400', '-0.67%'],
                    ['November', '14,000', '14,000', '0%', '£1,400', '£1,400', '0%', '2,400', '2,300', '-0.67%'],
                    ['December', '15,000', '480 *', '-', '£1,500', '£48 *', '-', '2,400', '78 *', '-']]
            if fuel_type == :gas
              [['2,700', '2,700', '0%'],
               ['2,500', '2,500', '+3.6%'],

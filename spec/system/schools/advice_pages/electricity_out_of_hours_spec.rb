  ...
  context 'as school admin' do
    ...
    context "clicking the 'Insights' tab" do
      ...
      it 'includes introduction' do
        expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.insights.title'))
      end
      ...
      context 'with very limited meter data' do
        ...
        it 'does not have other sections' do
          expect(page).to have_no_text(I18n.t('advice_pages.electricity_out_of_hours.insights.your_out_of_hours_usage_title'))
          expect(page).to have_no_text(I18n.t('advice_pages.electricity_out_of_hours.insights.comparison.title'))
        end
      end
      ...
      context 'with more than a week of meter data' do
        ...
        it 'includes a summary of available data' do
          expect(page).to have_text("Since #{reading_start_date.to_fs(:es_short)}, 100&percnt; of your electricity was used when the school was closed")
        end

        it 'previews the comparison with other schools' do
          expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.insights.comparison.title'))
          ...
          expect(page).to have_no_css('#comparison-electricity-out-of-hours')
      ...
      context 'with more than a years meter data' do
        it 'includes a summary of whole year' do
          expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.insights.your_out_of_hours_usage_title'))
          expect(page).to have_text('Over the last year 100&percnt; of your electricity was used when the school was closed')
        end
    ...
    context "clicking the 'Analysis' tab" do
      ...
      it 'includes introduction' do
        expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.summary'))
      end
      ...
      context 'with less than a year of meter data' do
        ...
        it 'has last year section' do
          expect(page).to have_text(I18n.t('advice_pages.electricity_long_term.analysis.recent_trend.title'))
          expect(page).to have_no_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.last_twelve_months.title'))
        ...
        it 'has by day section' do
          expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.usage_by_day_of_week.title'))
          expect(page).to have_css('#chart_wrapper_electricity_by_day_of_week_tolerant')
        end

        it 'does not have a holiday usage section' do
          expect(page).to have_no_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.holiday_usage.title'))
          expect(page).to have_no_css('#chart_wrapper_management_dashboard_group_by_week_electricity')
          ...
          context 'with one holiday in period of meter data' do
            ...
            it 'has holiday usage section' do
              travel_to reading_end_date do
                refresh
                expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.holiday_usage.title'))
      ...
      context 'with more than a years meter data' do
        ...
        it 'has last year section' do
          expect(page).to have_no_text(I18n.t('advice_pages.electricity_long_term.analysis.recent_trend.title'))
          expect(page).to have_text(I18n.t('advice_pages.electricity_out_of_hours.analysis.last_twelve_months.title'))
          expect(page).to have_css('#chart_wrapper_daytype_breakdown_electricity_tolerant')
          expect(page).to have_css('#electricity-out-of-hours-table')
        end

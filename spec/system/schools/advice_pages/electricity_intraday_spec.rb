...
RSpec.describe "electricity intraday advice page", type: :system do
  ...
  context 'as school admin' do
    ...
    before do
      sign_in(user)
      allow_any_instance_of(Usage::PeakUsageBenchmarkingService).to receive(:average_peak_usage_kw) { 9_999_999.0 }
      allow_any_instance_of(Usage::PeakUsageCalculationService).to receive(:average_peak_kw) { 9_999_999.0 }

...
RSpec.describe 'Solar edge installation management', :solar_edge_installations, type: :system do
  ...
  context 'when an admin' do
    before do
      ...
      allow_any_instance_of(DataFeeds::SolarEdgeApi).to receive(:site_start_end_dates).and_return([Date.yesterday,
                                                                                                   Time.zone.today])
    ...
    context 'with existing installation' do
      ...
      context 'when submitting a loading job' do
        ...
        it 'submits the job' do
          ...
          expect(Solar::SolarEdgeLoaderJob).to receive(:perform_later).with(installation: installation,
      ...
      it 'removes meters and readings on deletion' do
        ...
        expect do
          click_on 'Delete'
                      ...
                      :count).by(-3).and change(SolarEdgeInstallation,

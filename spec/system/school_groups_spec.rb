    ...
    context 'when logged in as the group admin' do
      ...
      context 'shows the sub navigation menu' do
        ...
        it 'shows only the sub nav manage school links available to a group admin' do
          visit school_group_path(school_group)
          expect(find('#dropdown-manage-school-group').all('a').collect(&:text)).to eq(["Chart settings", "Clusters"])
        end
      end
    ...
    context 'when logged in as an admin' do
      ...
      context 'shows the sub navigation menu' do
        ...
        it 'shows the sub nav manage school links available to an admin' do
          visit school_group_path(school_group)
          expect(find('#dropdown-manage-school-group').all('a').collect(&:text)).to eq(['Chart settings', 'Clusters', 'Edit group', 'Set message', 'Manage users', 'Manage partners', 'Group admin'])
        end
      end

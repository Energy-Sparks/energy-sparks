  ...
  context 'when on the analysis page' do
    ...
    context 'when not signed in' do
      ...
      context 'with potential savings' do
        it {
          expect(page).to have_text(I18n.t('school_groups.advice_pages.heating_control.analysis.potential_savings.title'))
        }
      ...
      context 'with comparison section' do
        it {
          expect(page).to have_text(I18n.t('school_groups.advice_pages.heating_control.analysis.comparisons.title'))
        }

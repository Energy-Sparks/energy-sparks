  ...
  context 'when on the insights page' do
    ...
    context 'when not signed in' do
      ...
      it 'has the comparisons section' do
        ...
        expect(page).to have_link(href: analysis_school_group_advice_baseload_path(school_group,
                                                                                   anchor: 'potential-savings'))
      end
  ...
  context 'when on the analysis page' do
    ...
    context 'when not signed in' do
      ...
      context 'with potential savings' do
        it {
          expect(page).to have_text(I18n.t('school_groups.advice_pages.baseload.analysis.potential_savings.title'))
        }

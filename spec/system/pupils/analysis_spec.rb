...
describe 'Pupil analysis' do
  ...
  shared_examples 'it has a top-level compare section' do |fuel_type:|
    it {
      expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_different_weeks'), period: :weekly,
                                                                                         supply: fuel_type)
    }

    it {
      expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_different_days'), period: :daily,
                                                                                        supply: fuel_type)
    }

    it {
      expect(page).to have_no_link(I18n.t('pupils.analysis.compare_meters'),
                                   href: school_usage_path(school, period: :weekly, supply: fuel_type,
                                                                   split_meters: true))
    }
    ...
    context 'with multiple meters and no storage heaters' do
      ...
      it {
        expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_meters'), period: :weekly, supply: fuel_type,
                                                                                  split_meters: true)
      }
    end
  end
  ...
  shared_examples 'a bar charts category' do |energy:, fuel_type:|
    ...
    it {
      expect_chart_link(school, I18n.t('pupils.analysis.compare_electricity_across_schools'), energy, 'Bar', 'Bench')
    }
  ...
  shared_examples 'a line charts category' do |energy:, fuel_type:|
    ...
    it {
      expect(page).to have_no_link(I18n.t('pupils.analysis.compare_meters'),
                                   href: school_usage_path(school, period: :daily, supply: fuel_type,
                                                                   split_meters: true))
    }
    ...
    context 'with multiple electricity meters and no storage heaters' do
      ...
      it {
        expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_meters'), period: :daily, supply: fuel_type,
                                                                                  split_meters: true)
      }
    end
  end
  ...
  context 'when viewing gas category' do
    ...
    context 'when viewing line charts' do
      ...
      it {
        expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_different_days'), period: :daily, supply: :gas)
      }

      it {
        expect(page).to have_no_link(I18n.t('pupils.analysis.compare_meters'),
                                     href: school_usage_path(school, period: :daily, supply: :gas,
                                                                     split_meters: true))
      }
      ...
      context 'with multiple electricity meters and no storage heaters' do
        ...
        it {
          expect_usage_chart_link(school, I18n.t('pupils.analysis.compare_meters'), period: :daily, supply: :gas,
                                                                                    split_meters: true)
        }
      end
    end

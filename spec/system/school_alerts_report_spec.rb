...
RSpec.describe 'school alerts', type: :system do
  ...
  let(:gas_fuel_alert_type) do
    create(:alert_type, fuel_type: :gas, frequency: :termly, description: gas_fuel_alert_type_description)
  end
  ...
  it 'shows all alerts' do
    ...
    create(:alert, alert_type: gas_fuel_alert_type, run_on: gas_date, school: school, rating: 5.0,

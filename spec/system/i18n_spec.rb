...
RSpec.describe 'i18n', type: :system do
  ...
  context 'switches the site to the users preferred locale on log in' do
    ...
    let!(:activity_type) do
      create(:activity_type, name_en: activity_type_name_en, name_cy: activity_type_name_cy,
                             activity_category: activity_category, key_stages: [ks1], subjects: [subject], data_driven: activity_data_driven)
    end

...
RSpec.describe 'Footer', type: :system do
  ...
  describe 'Second Footer' do
    ...
    it {
      expect(block).to have_text 'Content on this website is published under a Creative Commons Attribution 4.0 Licence.'
    }

    it {
      expect(block).to have_text 'Energy Sparks is a registered charity in England and Wales, registration 1189273.'
    }

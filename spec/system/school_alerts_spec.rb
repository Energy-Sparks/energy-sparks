...
RSpec.describe 'dashboard alerts', type: :system do
  ...
  let!(:gas_fuel_alert_type) do
    create(:alert_type, fuel_type: :gas, frequency: :termly, description: description, advice_page: advice_page)
  end
  ...
  context 'with a generated alert' do
    ...
    describe 'when visiting school dashboard' do
      it 'can shows the alert' do
        visit root_path
        expect(page).to have_text('Your heating is on!')
        expect(page).to have_text('Find out more')
      end
    end
    ...
    describe 'when visiting the pupil dashboard' do
      it 'shows the alert' do
        ...
        expect(page).to have_text('It is too warm')
        expect(page).to have_text('Find out more')
      end
    end
  end

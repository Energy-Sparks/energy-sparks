...
describe 'annual_energy_costs' do
  ...
  let(:electricity_variables) { { last_year_gbp: 161059.43999999994 } }
  ...
  let(:energy_variables) do
    {
      ...
      last_year_kwh: 115096.06680000003
    }
  end
  ...
  context 'when viewing report' do
    ...
    it_behaves_like 'a school comparison report with a table' do
      ...
      let(:expected_table) do
        [headers,
         [school.name, '£161,000', '£3,160', '£1,240', '£12,600', '£76.60', '22.5', '115,000', 'Primary', '363', '3,080'],

...
RSpec.describe CalendarsController, type: :controller do
  ...
  context "As an admin user" do
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new Calendar" do
          ...
          }.to change(Calendar.unscoped, :count).by(1)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested calendar" do
          ...
          calendar.reload
          expect(calendar.name).to eq new_attributes[:name]
        end
    ...
    describe "DELETE #destroy" do
      it "does not destroy the requested calendar" do
        calendar = Calendar.create! valid_attributes
        expect {
          delete :destroy, params: { id: calendar.to_param }
        }.to change(Calendar.unscoped, :count).by(0)
      end

      it "changes the deleted attribute to true" do
        calendar = Calendar.create! valid_attributes
        delete :destroy, params: { id: calendar.to_param }
        calendar.reload
        expect(calendar.deleted).to be_truthy
      end

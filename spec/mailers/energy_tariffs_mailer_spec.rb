...
describe EnergyTariffsMailer, :include_application_helper do
  ...
  context 'with tariff set' do
    before do
      ...
      # create(:energy_tariff, :with_flat_price, tariff_holder: )
      described_class.reminder(user).deliver_now
    end
    ...
    fcontext 'with a school admin' do
    ...
    fcontext 'with a group admin' do

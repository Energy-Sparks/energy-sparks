...
RSpec.describe AdminMailer, include_application_helper: true do
  ...
  describe '#school_group_meters_report' do
    ...
    let!(:active_meter) { create :gas_meter, mpan_mprn: 12_345_678, active: true, school: create(:school, school_group: school_group) }
    let!(:inactive_meter) { create :gas_meter, mpan_mprn: 87_654_321, active: false, school: create(:school, school_group: school_group) }

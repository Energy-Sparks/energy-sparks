...
describe DataFeeds::PerseApi do
  ...
  describe '#meter_history_readings' do
    it 'parses sandbox data' do
      ...
      readings = described_class.meter_history_readings('mpan', Date.new(2024, 1, 1))
      expect(readings.first).to eq(['2024-12-01', [17.4, 17.7, 17.5, 17.9, 17.9, 17.0, 17.1, 17.9, 18.0, 16.6,

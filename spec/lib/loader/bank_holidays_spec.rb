...
module Loader
  ...
  describe BankHolidays do
    ...
    let!(:national_calendar)  { create :calendar, calendar_type: :national, calendar_area: calendar_area }
    ...
    it 'should cascade to child calendars' do
      child_calendar = create :calendar, calendar_area: calendar_area, based_on_id: national_calendar.id, calendar_type: :regional
      BankHolidays.load!(sample_file)

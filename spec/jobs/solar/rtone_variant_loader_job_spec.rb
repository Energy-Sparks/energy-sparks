  ...
  describe '#perform' do
    ...
    context 'when the load is successful' do
      ...
      it 'calls the upserter' do
        expect(Solar::RtoneVariantDownloadAndUpsert).to receive(:new).with(start_date: start_date, end_date: end_date,
      ...
      context 'when sending the email' do
        ...
        it_behaves_like 'a successful solar loader job', solar_feed_type: 'Rtone Variant' do
    ...
    context 'when the load is unsuccessful' do
      ...
      context 'with a loading error' do
        ...
        it_behaves_like 'a solar loader job with loader errors', solar_feed_type: 'Rtone Variant' do
          let(:installation_for) { installation.school.name }
        end
      end
      ...
      context 'with an unexpected exception' do
        ...
        it_behaves_like 'a solar loader job that had an exception', solar_feed_type: 'Rtone Variant' do
          let(:installation_for) { installation.school.name }
        end
      end
    end

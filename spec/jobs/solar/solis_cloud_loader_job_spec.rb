  ...
  describe '#perform' do
    ...
    context 'when the load is successful' do
      ...
      it 'calls the upserter' do
        expect(upserter).to have_received(:perform) # rubocop:disable RSpec/MessageSpies
      end

      context 'when sending the email' do
        it_behaves_like 'a successful solar loader job', solar_feed_type: 'SolisCloud'
      end
    end
    ...
    context 'when the load is unsuccessful' do
      ...
      context 'with a loading error' do
        it_behaves_like 'a solar loader job with loader errors', solar_feed_type: 'SolisCloud'
      end
      ...
      context 'with an unexpected exception' do
        ...
        it_behaves_like 'a solar loader job that had an exception', solar_feed_type: 'SolisCloud'
      end
    end
  end
end

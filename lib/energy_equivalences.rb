...
class EnergyEquivalences
  ...
  def self.equivalence_types(include_basic_types = true)
    ...
    list = list.reject { |k, _v| %i[electricity gas].include? k } unless include_basic_types
    list.keys
  end
  ...
  private_class_method def self.create_configuration(uk_electric_grid_co2_kg_kwh)
    water_energy_description = "It takes #{X.format(:kwh,
                                                    WATER_ENERGY_KWH_LITRE_PER_K)} of energy to heat 1 litre of water by 1C. "
    ...
    shower_description_to_kwh = \
      ...
      "It therefore takes #{X.format(:litre,
                                     SHOWER_LITRES)} &times; #{X.format(:kwh, WATER_ENERGY_KWH_LITRE_PER_K)} &times; " +
    ...
    one_kettle_description_to_kwh = \
      ...
      "Therefore it takes #{X.format(:litre,
                                     KETTLE_LITRES)} &times; 85C &times; #{X.format(:kwh,
                                                                                    WATER_ENERGY_KWH_LITRE_PER_K)} " \
      "= #{X.format(:kwh, KETTLE_KWH)} of energy to boil 1 kettle. ".freeze

    ice_car_efficiency = "A petrol car uses #{X.format(:litre,
                                                       ICE_LITRES_PER_100KM)} of fuel to travel 100 km (40 mpg). "

    ice_description_to_kwh = \
      ice_car_efficiency +
      "Each litre of petrol contains #{X.format(:kwh, LITRE_PETROL_KWH)} of energy, thus it takes " \
      "#{X.format(:litre,
                  ICE_LITRES_PER_100KM)} &times; #{X.format(:kwh, LITRE_PETROL_KWH)}/l &divide; 100 km = " \
    ...
    ice_description_to_£ = \
      ...
      "so it costs #{X.format(:litre,
                              ICE_LITRES_PER_100KM)} &times; #{X.format(:£, LITRE_PETROL_£)} &divide; 100km " \
    ...
    bev_efficiency_description = "An electric car uses #{X.format(:kwh,
                                                                  BEV_KWH_PER_KM)} of electricity to travel 1 km. "
    bev_co2_description = "An electric car emits #{X.format(:co2,
                                                            bev_co2_per_km)} of electricity to travel 1 km (emissons from the National Grid). "
      ...
      electricity: {
        ...
        conversions: {
          ...
          co2: {
            ...
            description: "The UK electricity grid emitted an average of #{X.format(:co2,
                                                                                   uk_electric_grid_co2_kg_kwh)} " \
      ...
      home: {
        ...
        conversions: {
          ...
          co2: {
            ...
            description: "An average uk home uses #{X.format(:kwh, HOMES_ELECTRICITY_KWH_YEAR)} of electricity " \
                          "and #{X.format(:kwh, HOMES_GAS_KWH_YEAR)} of gas per year. " \
                          "The carbon intensity of 1 kWh of electricity = #{X.format(:co2,
                                                                                     uk_electric_grid_co2_kg_kwh)}/kWh and " \
                          "gas #{X.format(:co2, co2_kg_kwh(:gas))}/kWh. " \
                          "Therefore 1 home emits #{X.format(:kwh,
                                                             HOMES_ELECTRICITY_KWH_YEAR)} &times; #{X.format(:co2,
                                                                                                             uk_electric_grid_co2_kg_kwh)} + " \
          ...
          £: {
            ...
            description: "An average uk home uses #{X.format(:kwh, HOMES_ELECTRICITY_KWH_YEAR)} of electricity " \
                          "and #{X.format(:kwh, HOMES_GAS_KWH_YEAR)} of gas per year. " \
                          "For homes the cost of 1 kWh of electricity = #{X.format(:£,
                                                                                   UK_DOMESTIC_ELECTRICITY_£_KWH)}/kWh and " \
                          "gas #{X.format(:£, UK_DOMESTIC_GAS_£_KWH)}/kWh. " \
                          "Therefore 1 home costs #{X.format(:kwh,
                                                             HOMES_ELECTRICITY_KWH_YEAR)} &times; #{X.format(:£,
                                                                                                             UK_DOMESTIC_ELECTRICITY_£_KWH)} + " \
      ...
      homes_electricity: {
        ...
        conversions: {
          ...
          co2: {
            ...
            description: "A average uk home uses #{X.format(:kwh, HOMES_ELECTRICITY_KWH_YEAR)} of electricity. " \
                          "The carbon intensity of 1 kWh of electricity = #{X.format(:co2,
                                                                                     uk_electric_grid_co2_kg_kwh)}/kWh. " \
                          "Therefore 1 home emits #{X.format(:kwh,
                                                             HOMES_ELECTRICITY_KWH_YEAR)} &times; #{X.format(:co2,
                                                                                                             uk_electric_grid_co2_kg_kwh)} = " \
          ...
          £: {
            ...
            description: "An average uk home uses #{X.format(:kwh, HOMES_ELECTRICITY_KWH_YEAR)} of electricity. " \
                          "For homes the cost of 1 kWh of electricity = #{X.format(:£,
                                                                                   UK_DOMESTIC_ELECTRICITY_£_KWH)}/kWh. " \
                          "Therefore 1 home costs #{X.format(:kwh,
                                                             HOMES_ELECTRICITY_KWH_YEAR)} &times; #{X.format(:£,
                                                                                                             UK_DOMESTIC_ELECTRICITY_£_KWH)} = " \
        ...
        conversions: {
          ...
          co2: {
            ...
            description: "A average uk home uses #{X.format(:kwh, HOMES_GAS_KWH_YEAR)} of gas. " \
                          ...
                          "Therefore 1 home emits #{X.format(:kwh,
                                                             HOMES_GAS_KWH_YEAR)} &times; #{X.format(:co2,
                                                                                                     co2_kg_kwh(:gas))} = " \
          ...
          £: {
            ...
            description: "An average uk home uses #{X.format(:kwh, HOMES_GAS_KWH_YEAR)} of gas. " \
                          ...
                          "Therefore 1 home costs #{X.format(:kwh,
                                                             HOMES_GAS_KWH_YEAR)} &times; #{X.format(:£,
                                                                                                     UK_DOMESTIC_GAS_£_KWH)} = " \
      ...
      shower: {
        ...
        conversions: {
          ...
          co2: {
            rate: shower_co2_kg,
            description: shower_description_to_kwh +
              "Burning 1 kwh of gas (normal source of heat for showers) emits #{X.format(:kg,
                                                                                         co2_kg_kwh(:gas))} CO2. " \
          ...
          £: {
            ...
            description: shower_description_to_kwh +
              ...
              "Therefore 1 shower costs #{X.format(:kwh,
                                                   SHOWER_KWH_NET)} &times; #{X.format(:£,
                                                                                       UK_GAS_£_KWH)} = #{X.format(:£,
                                                                                                                   SHOWER_£)} of gas. ",
      ...
      kettle: {
        ...
        conversions: {
          ...
          co2: {
            rate: kettle_co2_kg,
            description: one_kettle_description_to_kwh +
              "And, heating 1 kettle emits #{X.format(:kwh,
                                                      KETTLE_KWH)} &times; #{X.format(:co2,
                                                                                      uk_electric_grid_co2_kg_kwh)} " \
      ...
      smartphone: {
        ...
        conversions: {
          ...
          co2: {
            ...
            description: "It takes #{X.format(:kwh, SMARTPHONE_CHARGE_kWH)} to charge a smartphone. " \
                                    "Generating 1 kWh of electricity produces #{X.format(:co2,
                                                                                         UK_ELECTRIC_GRID_£_KWH)}. " \
                                    "Therefore charging one smartphone produces #{X.format(:co2,
                                                                                           smart_phone_charge_co2_kg)}. ",
      ...
      computer_console: {
        ...
        conversions: {
          kwh: {
            ...
            description: "Computer consoles use about #{X.format(:kwh,
                                                                 COMPUTER_CONSOLE_POWER_KW)} of electricity every hour. ",
          ...
          co2: {
            ...
            description: "Computer consoles use about #{X.format(:kwh,
                                    ...
                                    "Generating 1 kWh of electricity produces #{X.format(:co2,
                                                                                         UK_ELECTRIC_GRID_£_KWH)}. " \
                                    "Therefore using a computer console  for 1 hour produces #{X.format(:co2,
                                                                                                        computer_console_co2_kg)}. ",
          ...
          £: {
            ...
            description: "Computer consoles use about #{X.format(:kwh,
                                                                 COMPUTER_CONSOLE_POWER_KW)} of electricity every hour. " \
                          "Generating 1 kWh of electricity costs #{X.format(:£, UK_ELECTRIC_GRID_£_KWH)}. " \
                          "Therefore using a computer console for 1 hour costs #{X.format(:£,
                                                                                          COMPUTER_CONSOLE_HOUR_£)}. ",
      ...
      teaching_assistant: {
        ...
        conversions: {
          £: {
            ...
            description: "A school teaching assistant is paid on average #{X.format(:£,
                                                                                    TEACHING_ASSISTANT_£_HOUR)} per hour.",
      ...
      carnivore_dinner: {
        ...
        conversions: {
          co2: {
            ...
            description: "#{X.format(:co2,
                                     CARNIVORE_DINNER_CO2_KG)} of CO2 is emitted producing one dinner containing meat.",
      ...
      vegetarian_dinner: {
        ...
        conversions: {
          co2: {
            ...
            description: "#{X.format(:co2,
                                     VEGETARIAN_DINNER_CO2_KG)} of CO2 is emitted producing one vegetarian dinner.",
      ...
      onshore_wind_turbine_hours: {
        ...
        conversions: {
          kwh: {
            ...
            description: "An average onshore wind turbine has a maximum capacity of #{X.format(:kw,
                                                                                               ONSHORE_WIND_TURBINE_CAPACITY_KW)}. " \
                          "On average (wind varies) it is windy enough to use #{X.format(:percent,
                                                                                         ONSHORE_WIND_TURBINE_LOAD_FACTOR_PERCENT)} of that capacity. " \
                          "Therefore an average onshore wind turbine generates about #{X.format(:kwh,
                                                                                                ONSHORE_WIND_TURBINE_AVERAGE_KW_PER_HOUR)} per hour.",
      ...
      offshore_wind_turbine_hours: {
        ...
        conversions: {
          kwh: {
            ...
            description: "An average offshore wind turbine has a maximum capacity of #{X.format(:kw,
                                                                                                OFFSHORE_WIND_TURBINE_CAPACITY_KW)}. " \
                          "On average (wind varies) it is windy enough to use #{X.format(:percent,
                                                                                         OFFSHORE_WIND_TURBINE_LOAD_FACTOR_PERCENT)} of that capacity. " \
                          "Therefore an average offshore wind turbine generates about #{X.format(:kwh,
                                                                                                 OFFSHORE_WIND_TURBINE_AVERAGE_KW_PER_HOUR)} per hour.",

...
module Alerts
  class UsageDuringCurrentHolidayBase < AlertAnalysisBase
    USAGE_THRESHOLD_GBP = 10.0
    attr_reader :holiday_usage_to_date_kwh, :holiday_usage_to_date_gbp, :holiday_usage_to_date_co2,
                :holiday_projected_usage_kwh, :holiday_projected_usage_gbp, :holiday_projected_usage_co2
    alias holiday_usage_to_date_£ holiday_usage_to_date_gbp # rubocop:disable Naming/MethodName, Naming/AsciiIdentifiers
    alias holiday_projected_usage_£ holiday_projected_usage_gbp # rubocop:disable Naming/MethodName, Naming/AsciiIdentifiers
    ...
    def calculate(asof_date)
      ...
      @holiday_usage_to_date_gbp = totals_to_date[:£]
      ...
      @holiday_projected_usage_gbp = projected_totals[:£]
      ...
      @rating = @holiday_usage_to_date_gbp < USAGE_THRESHOLD_GBP ? nil : 0.0
    end

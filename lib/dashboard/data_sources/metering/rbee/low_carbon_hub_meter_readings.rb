...
class LowCarbonHubMeterReadings
  ...
  private def convert_raw_readings_to_meter_readings(data, urn, start_date, end_date)
    reading_sets = {}
  ...
  private def convert_to_meter_readings(raw_data, type, urn, start_date, end_date)
  ...
  private def convert_date_to_x48_to_one_day_readings(raw_meter_readings, mpan_mprn, start_date, end_date)
    meter_readings = {}

...
class TargetMeter
  class OneYearTargetingAndTrackingAmrData
    ...
    def fit_electricity
      if @meter.annual_kwh_estimate.nil?
        raise MissingAnnualKwhEstimate,
              "No annual kwh estimate attribute set for #{@meter.fuel_type}"
      end
    ...
    def seasonal_electricity_covid_adjustment
      @seasonal_electricity_covid_adjustment ||= Covid3rdLockdownElectricityCorrection.new(@meter,

...
namespace :solar do
  ...
  task :import_rtone_variant_readings, %i[start_date end_date] => :environment do |_t, args|
    ...
    begin
      RtoneVariantInstallation.active.find_each do |installation|
        puts "Running for #{installation.rtone_meter_id}"
        Solar::RtoneVariantDownloadAndUpsert.new(installation: installation, start_date: start_date,

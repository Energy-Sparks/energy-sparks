namespace :after_party do
  ...
  task add_solar_edge_installation_for_freshford: :environment do
    ...
    solar_edge_params = {}
    solar_edge_params['school_id'] = School.find_by(name: 'Freshford Church School').id
    solar_edge_params['amr_data_feed_config_id'] = AmrDataFeedConfig.find_by(identifier: 'solar-edge').id

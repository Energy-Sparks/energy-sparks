namespace :after_party do
  desc 'Deployment task: create_daily_electric_gdst_feeds'
  task create_daily_electric_gdst_feeds: :environment do
    puts "Running deploy task 'create_daily_electric_gdst_feeds'"

    # Put your task implementation HERE.
    AmrDataFeedConfig.create!(
      description: 'GDST electricity',
      identifier: 'gdst-electricity',
      date_format: "%d/%m/%y",

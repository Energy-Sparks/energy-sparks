namespace :after_party do
  ...
  task add_ooh_alerts: :environment do
    ...
    unless AlertType.find_by(class_name: 'AlertOutOfHoursElectricityUsagePreviousYear')
      AlertType.create!(
        frequency: :weekly,
    ...
    unless AlertType.find_by(class_name: 'AlertOutOfHoursGasUsagePreviousYear')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
    ...
    unless AlertType.find_by(class_name: 'AlertOutOfHoursStorageHeaterUsagePreviousYear')
      AlertType.create!(
        frequency: :weekly,

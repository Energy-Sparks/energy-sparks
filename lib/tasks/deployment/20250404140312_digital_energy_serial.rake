namespace :after_party do
  desc 'Deployment task: digital_energy_serial'
  task digital_energy_serial: :environment do
    puts "Running deploy task 'digital_energy_serial'"

    new_config = {}
    new_config['description'] = 'Digital Energy (Serial Number)'
    new_config['identifier'] = 'digital-energy-serial'

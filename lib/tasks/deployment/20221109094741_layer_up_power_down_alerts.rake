namespace :after_party do
  ...
  task layer_up_power_down_alerts: :environment do
    ...
    unless AlertType.find_by(class_name: 'AlertLayerUpPowerdown11November2022ElectricityComparison')
      AlertType.create!(
        frequency: :weekly,
    ...
    unless AlertType.find_by(class_name: 'AlertLayerUpPowerdown11November2022GasComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
    ...
    unless AlertType.find_by(class_name: 'AlertLayerUpPowerdown11November2022StorageHeaterComparison')
      AlertType.create!(
        frequency: :weekly,

namespace :after_party do
  ...
  task easter_shutdown_alerts: :environment do
    ...
    AlertType.create!(
      ...
      has_ratings: true,
      benchmark: true
    ) unless AlertType.find_by_class_name('AlertEaster2023ShutdownElectricityComparison')
    ...
    AlertType.create!(
      ...
      has_ratings: true,
      benchmark: true
    ) unless AlertType.find_by_class_name('AlertEaster2023ShutdownGasComparison')
    ...
    AlertType.create!(
      ...
      has_ratings: true,
      benchmark: true
    ) unless AlertType.find_by_class_name('AlertEaster2023ShutdownStorageHeaterComparison')

namespace :after_party do
  ...
  task new_comparison_benchmarks: :environment do
    ...
    unless AlertType.find_by(class_name: 'AlertAutumnTerm20212022ElectricityComparison')
      AlertType.create!(
        frequency: :weekly,
    ...
    unless AlertType.find_by(class_name: 'AlertAutumnTerm20212022GasComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
    ...
    unless AlertType.find_by(class_name: 'AlertAutumnTerm20212022StorageHeaterComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
    ...
    unless AlertType.find_by(class_name: 'AlertSeptNov20212022ElectricityComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
        sub_category: :electricity_use,
    ...
    unless AlertType.find_by(class_name: 'AlertSeptNov20212022GasComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
        sub_category: :heating,
    ...
    unless AlertType.find_by(class_name: 'AlertSeptNov20212022StorageHeaterComparison')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
        sub_category: :storage_heaters,

namespace :after_party do
  ...
  task holiday_heating_water_alerts: :environment do
    ...
    unless AlertType.find_by(class_name: 'AlertGasHeatingHotWaterOnDuringHoliday')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
    ...
    unless AlertType.find_by(class_name: 'AlertStorageHeaterHeatingOnDuringHoliday')
      AlertType.create!(
        frequency: :weekly,

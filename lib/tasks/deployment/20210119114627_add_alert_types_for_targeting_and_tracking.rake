namespace :after_party do
  ...
  task add_alert_types_for_targeting_and_tracking: :environment do
    ...
    unless AlertType.find_by(class_name: 'AlertElectricityTargetAnnual')
      AlertType.create!(
        frequency: :weekly,
    ...
    unless AlertType.find_by(class_name: 'AlertGasTargetAnnual')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
    ...
    unless AlertType.find_by(class_name: 'AlertElectricityTarget4Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
        sub_category: :electricity_use,
    ...
    unless AlertType.find_by(class_name: 'AlertGasTarget4Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
        sub_category: :heating,
    ...
    unless AlertType.find_by(class_name: 'AlertElectricityTarget1Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
        sub_category: :electricity_use,
    ...
    unless AlertType.find_by(class_name: 'AlertGasTarget1Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
        sub_category: :heating,
    ...
    unless AlertType.find_by(class_name: 'AlertStorageHeaterTargetAnnual')
      AlertType.create!(
        frequency: :weekly,
    ...
    unless AlertType.find_by(class_name: 'AlertStorageHeaterTarget4Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :storage_heater,
        sub_category: :storage_heaters,
    ...
    unless AlertType.find_by(class_name: 'AlertStorageHeaterTarget1Week')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :storage_heater,
        sub_category: :storage_heaters,
    ...
    unless AlertType.find_by(class_name: 'AdviceTargetsElectricity')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :electricity,
        sub_category: :electricity_use,
    ...
    unless AlertType.find_by(class_name: 'AdviceTargetsGas')
      AlertType.create!(
        frequency: :weekly,
        fuel_type: :gas,
        sub_category: :heating,

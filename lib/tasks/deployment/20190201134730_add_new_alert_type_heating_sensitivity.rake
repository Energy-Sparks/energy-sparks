namespace :after_party do
  ...
  task add_new_alert_type_heating_sensitivity: :environment do
    ...
    AlertType.where(fuel_type: :gas, sub_category: :heating, frequency: :weekly, title: 'Heating Sensitivity Advice', class_name: 'AlertHeatingSensitivityAdvice', show_ratings: true).first_or_create

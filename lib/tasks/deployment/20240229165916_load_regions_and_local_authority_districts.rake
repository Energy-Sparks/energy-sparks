namespace :after_party do
  ...
  task load_regions_and_local_authority_districts_2024: :environment do
    puts "Running deploy task 'load_regions_and_local_authority_districts'"

    file_name = File.join( File.expand_path(File.dirname(__FILE__)) , "schools-to-lads-2024-02.csv" )
    #id,RGN22NM,LAD22CD
